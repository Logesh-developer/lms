...
@Component({
  selector: 'app-hr-reportcalendar',
  templateUrl: './hr-reportcalendar.component.html',
  styleUrl: './hr-reportcalendar.component.scss'
})
export class HrReportcalendarComponent {
